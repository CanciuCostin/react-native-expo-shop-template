import { ProductTag, Product } from "@models/types";

export const DUMMY_CATEGORY_TAGS : Array<ProductTag> = [
    {
        tagId: 1,
        tagName: "New"
      },
...
export const DUMMY_PRODUCTS = [
  ...
  },
  {
    productId: 10,
    categoryId: 6,
    productTitle: 'Triple Berry Smoothie',
    photos: [
    ...
    productTags: [2, 3],
    productDescription: 'In a blender, combine all ingredients and blend until smooth. Then divide between 2 cups and top with blackberries, if desired.'
  },
  {
    productId: 11,
    categoryId: 7,
    productTitle: 'Vegan Cookies',
    photos: [
  ...
  },
  {
    productId: 12,
    categoryId: 7,
    productTitle: 'Pumpkin Spice Cookies',
    photos: [
  ...
  },
  {
    productId: 14,
    categoryId: 8,
    productTitle: 'Perfect Fish Tacos',
    photos: [
  ...
  },
  {
    productId: 18,
    categoryId: 7,
    productTitle: 'Spaghetti Carbonara',
    photos: [
      'https://ak3.picdn.net/shutterstock/products/10431533/thumb/10.jpg',
